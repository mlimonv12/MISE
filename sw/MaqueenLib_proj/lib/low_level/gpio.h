...
#define JS_L BIT0    // P3.0
#define JS_SEL BIT2  // P3.2 (Select button)
#define JS_B BIT3    // P3.3 (Back button)
#define JS_F BIT4    // P3.4 (Forward button / Up in menu)
#define JS_R BIT5    // P3.5 (Right button / Down in menu)
...
extern volatile uint8_t joystick_back_pressed; // Assuming JS_B is "Back"
