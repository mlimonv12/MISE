 ...
 *
    RxReturn RxPacket(uint32_t time_out);   //El timeout deber�a ser un valor en el rango de los ms.
...
#define PWD_AP "c0nTra53nyA"    //cambiar por la contrase�a deseada
...
/*
 *  A partir de aqu�, lo que sigue NO se deber�a alterar!
 */
