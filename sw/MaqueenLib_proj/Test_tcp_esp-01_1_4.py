...
# =================================================================
Default_IP = "192.168.0.99"  # Editar con la IP del módulo ESP-01
# =================================================================
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.progress_bar_izq.grid(row=4, column=2, columnspan=3)
        ...
        self.label_trama.grid(row=5, column=2, columnspan=2)
        ...
        self.progress_bar_der.grid(row=6, column=2, columnspan=3)
        ...
        self.label_RGB.grid(row=10, column=3, sticky=W)
